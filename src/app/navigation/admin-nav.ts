      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav me-auto">
            <li class="nav-item">
              <a class="nav-link" (click)="navigate('/dashboard')" style="cursor: pointer;">
            ...
            <li class="nav-item">
              <a class="nav-link" (click)="navigate('/supplier')" style="cursor: pointer;">
                <i class="fas fa-truck me-1"></i>Suppliers
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" (click)="navigate('/stockmanagement')" style="cursor: pointer;">
